...
$.widget( "ui.textbox", {
	...
	// we should return the most abstract dom object, which is already in .element
	// and the base class widget() method already returns this.element;
	// widget: function() {
	...
	destroy: function() {
		...
		this.inputElement.unwrap();

		this.inputElement
			.removeClass( baseClasses + " " + stateClasses + " " + typeClasses )
			.removeAttr( "role" );

		// FIXME: workaround because i think i messed up, inputElement should be element, and
		//    element should be wrapElement.
		this.inputElement.removeData("textbox");
